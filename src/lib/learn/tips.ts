...
export const TIPS: Record<string, Tip> = Object.fromEntries(
	(
		[
			...
			['T12', 'Scrub through the animation one frame at a time and notice how little changes. Turn on onion skin when you need the neighboring frames as a guide.', 2],
			...
			['T21', 'Use From and To under the scrubber to repeat a smaller range of frames while you work on them.', 2],
