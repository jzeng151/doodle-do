...
<style>
	...
	.primary:hover:not(:disabled){background:var(--ink);color:var(--paper)}
	.primary:disabled{opacity:1;background:#4e4a4e;color:var(--paper);border-color:var(--ink)}
	.inverse-button:hover:not(:disabled){background:var(--paper);color:var(--ink)}
	.inverse-button:disabled{background:var(--paper-2);color:#4e4a4e;border-color:var(--paper-2)}
